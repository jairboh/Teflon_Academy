...
class Ui_MenuAdministrativo(object):
    def setupUi(self, MenuAdministrativo, cursor, id, LogIn):
        ...
        MenuAdministrativo.resize(1138, 836)
        icon = QtGui.QIcon()
...
"")
        ...
        self.frame_59 = QtWidgets.QFrame(self.Menu_Lateral_Frame)
        ...
        self.pushButton_18 = QtWidgets.QPushButton(self.frame_59)
        self.pushButton_18.setMinimumSize(QtCore.QSize(0, 50))
        self.pushButton_18.setStyleSheet("QPushButton{\n"
"    border: 0px;\n"
"    image: url(:/prefijoNuevo/Flecha.png);\n"
"}\n"
"QPushButton:hover{\n"
"    border: 10px;\n"
"    image: url(:/prefijoNuevo/FlechaHover.png);\n"
"}")
        self.pushButton_18.setText("")
        self.pushButton_18.setObjectName("pushButton_18")
        self.verticalLayout_35.addWidget(self.pushButton_18)
...
"}")
        ...
        self.verticalLayout_27 = QtWidgets.QVBoxLayout(self.frame_58)
        self.verticalLayout_27.setObjectName("verticalLayout_27")
        self.pushButton_17 = QtWidgets.QPushButton(self.frame_58)
        self.pushButton_17.setMinimumSize(QtCore.QSize(120, 150))
...
"}")
        ...
        self.verticalLayout_27.addWidget(self.pushButton_17)
        self.label_159 = QtWidgets.QLabel(self.frame_58)
        ...
        self.horizontalLayout_18.addWidget(self.frame_58)
...
"")
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 1092, 462))
...
"")
        ...
        self.scrollAreaWidgetContents_15.setGeometry(QtCore.QRect(0, 0, 87, 87))
        ...
        self.scrollAreaWidgetContents_11.setGeometry(QtCore.QRect(0, 0, 87, 87))
        ...
        self.scrollAreaWidgetContents_18.setGeometry(QtCore.QRect(0, 0, 997, 775))
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout_2.addWidget(self.label_17, 9, 0, 1, 1, QtCore.Qt.AlignRight)
...
"")
        ...
        self.gridLayout_2.addWidget(self.AlergiasRegistrar, 9, 3, 1, 2, QtCore.Qt.AlignLeft)
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout_2.addWidget(self.label_19, 10, 0, 1, 1, QtCore.Qt.AlignRight)
...
"")
        ...
        self.gridLayout_2.addWidget(self.MedicamentosRegistrar, 11, 3, 1, 2, QtCore.Qt.AlignLeft)
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout_2.addWidget(self.label_18, 11, 0, 1, 1, QtCore.Qt.AlignRight)
...
"")
        ...
        self.gridLayout_2.addWidget(self.EnfermedadesRegistrar, 10, 3, 1, 2, QtCore.Qt.AlignLeft)
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout_2.addWidget(self.label_45, 7, 0, 1, 1, QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
...
"")
        ...
        self.gridLayout_2.addWidget(self.GuardarRegistrarPaciente, 15, 3, 1, 2, QtCore.Qt.AlignHCenter)
...
"color: rgb(255, 255, 255);")
        ...
        self.MedicamentosRegistrar_6 = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_2)
        self.MedicamentosRegistrar_6.setMinimumSize(QtCore.QSize(600, 0))
        self.MedicamentosRegistrar_6.setCursor(QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self.MedicamentosRegistrar_6.setTabletTracking(True)
        self.MedicamentosRegistrar_6.setStyleSheet("font: 63 20pt \"Bahnschrift SemiBold SemiConden\";\n"
"background-color: rgb(255, 255, 255);\n"
"")
        self.MedicamentosRegistrar_6.setText("")
        self.MedicamentosRegistrar_6.setEchoMode(QtWidgets.QLineEdit.Password)
        self.MedicamentosRegistrar_6.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.MedicamentosRegistrar_6.setObjectName("MedicamentosRegistrar_6")
        self.gridLayout_2.addWidget(self.MedicamentosRegistrar_6, 12, 3, 1, 1, QtCore.Qt.AlignHCenter)
        self.label_148 = QtWidgets.QLabel(self.scrollAreaWidgetContents_2)
        self.label_148.setStyleSheet("font: 63 22pt \"Bahnschrift SemiBold SemiConden\";\n"
"color: rgb(255, 255, 255);")
        self.label_148.setObjectName("label_148")
        self.gridLayout_2.addWidget(self.label_148, 12, 0, 1, 1, QtCore.Qt.AlignRight)
...
"    color: rgb(0, 0, 0);")
        ...
        self.BuscarPor_4.addItem("")
        self.gridLayout_2.addWidget(self.BuscarPor_4, 7, 3, 1, 1)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.pushButton_3, 12, 4, 1, 1, QtCore.Qt.AlignLeft)
...
"    color: rgb(0, 0, 0);")
        ...
        self.BuscarPor_3.addItem("")
        self.gridLayout_6.addWidget(self.BuscarPor_3, 11, 1, 1, 1, QtCore.Qt.AlignHCenter)
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout_6.addWidget(self.label_39, 11, 0, 1, 1, QtCore.Qt.AlignRight)
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout_6.addWidget(self.label_33, 10, 0, 1, 1, QtCore.Qt.AlignRight)
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout_6.addWidget(self.label_35, 13, 0, 1, 1, QtCore.Qt.AlignRight)
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout_6.addWidget(self.label_36, 14, 0, 1, 1, QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
...
"")
        ...
        self.gridLayout_6.addWidget(self.AlergiasActualizar, 12, 1, 1, 1, QtCore.Qt.AlignHCenter)
...
"")
        ...
        self.gridLayout_6.addWidget(self.EnfermedadesActualizar, 13, 1, 1, 1, QtCore.Qt.AlignHCenter)
...
"")
        ...
        self.gridLayout_6.addWidget(self.FechNacActu, 9, 1, 1, 1, QtCore.Qt.AlignHCenter)
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout_6.addWidget(self.label_31, 5, 0, 1, 1, QtCore.Qt.AlignRight)
...
"")
        ...
        self.gridLayout_6.addWidget(self.TelefonoActualizarPaciente, 5, 1, 1, 1, QtCore.Qt.AlignHCenter)
...
"")
        ...
        self.gridLayout_6.addWidget(self.MedicamentosActualizar, 14, 1, 1, 1, QtCore.Qt.AlignHCenter)
...
"")
        ...
        self.gridLayout_6.addWidget(self.UltimCitActu, 10, 1, 1, 1, QtCore.Qt.AlignHCenter)
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout_6.addWidget(self.label_34, 12, 0, 1, 1, QtCore.Qt.AlignRight)
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout_6.addWidget(self.label_32, 9, 0, 1, 1, QtCore.Qt.AlignRight)
        self.MedicamentosRegistrar_7 = QtWidgets.QLineEdit(self.scrollAreaWidgetContents_3)
        self.MedicamentosRegistrar_7.setMinimumSize(QtCore.QSize(600, 0))
        self.MedicamentosRegistrar_7.setCursor(QtGui.QCursor(QtCore.Qt.IBeamCursor))
        self.MedicamentosRegistrar_7.setTabletTracking(True)
        self.MedicamentosRegistrar_7.setStyleSheet("font: 63 20pt \"Bahnschrift SemiBold SemiConden\";\n"
"background-color: rgb(255, 255, 255);\n"
"")
        self.MedicamentosRegistrar_7.setText("")
        self.MedicamentosRegistrar_7.setEchoMode(QtWidgets.QLineEdit.Password)
        self.MedicamentosRegistrar_7.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.MedicamentosRegistrar_7.setObjectName("MedicamentosRegistrar_7")
        self.gridLayout_6.addWidget(self.MedicamentosRegistrar_7, 15, 1, 1, 1, QtCore.Qt.AlignHCenter)
        self.label_154 = QtWidgets.QLabel(self.scrollAreaWidgetContents_3)
        self.label_154.setStyleSheet("font: 63 22pt \"Bahnschrift SemiBold SemiConden\";\n"
"color: rgb(255, 255, 255);")
        self.label_154.setObjectName("label_154")
        self.gridLayout_6.addWidget(self.label_154, 15, 0, 1, 1, QtCore.Qt.AlignRight|QtCore.Qt.AlignVCenter)
...
"color: rgb(255, 255, 255);")
        ...
        self.gridLayout_6.addWidget(self.label_29, 2, 1, 1, 1)
...
"")
        ...
        self.gridLayout_6.addWidget(self.ActualizarBotonPaciente, 16, 2, 1, 1, QtCore.Qt.AlignLeft)
...
"}")
        ...
        self.gridLayout_6.addWidget(self.pushButton_4, 15, 2, 1, 1, QtCore.Qt.AlignLeft)
...
"color: rgb(255, 255, 255);")
        ...
        self.HistorialCambios = QtWidgets.QWidget()
        self.HistorialCambios.setObjectName("HistorialCambios")
        self.verticalLayout_36 = QtWidgets.QVBoxLayout(self.HistorialCambios)
        self.verticalLayout_36.setObjectName("verticalLayout_36")
        self.frame_62 = QtWidgets.QFrame(self.HistorialCambios)
        ...
        self.horizontalLayout_15 = QtWidgets.QHBoxLayout(self.frame_62)
        self.horizontalLayout_15.setObjectName("horizontalLayout_15")
        self.BuscarRegistradosCombobox_8 = QtWidgets.QComboBox(self.frame_62)
        self.BuscarRegistradosCombobox_8.setContextMenuPolicy(QtCore.Qt.DefaultContextMenu)
        self.BuscarRegistradosCombobox_8.setStyleSheet("font: 63 20pt \"Bahnschrift SemiBold SemiConden\";\n"
"border: .5px solid #e6b31e;\n"
"background-color: rgb(52, 52, 52);\n"
"color: whitesmoke;")
        self.BuscarRegistradosCombobox_8.setObjectName("BuscarRegistradosCombobox_8")
        self.BuscarRegistradosCombobox_8.addItem("")
        self.BuscarRegistradosCombobox_8.addItem("")
        self.BuscarRegistradosCombobox_8.setItemText(2, "")
        self.horizontalLayout_15.addWidget(self.BuscarRegistradosCombobox_8)
        self.BuscarRegistradosPacientesText_5 = QtWidgets.QLineEdit(self.frame_62)
        self.BuscarRegistradosPacientesText_5.setStyleSheet("font: 63 20pt \"Bahnschrift SemiBold SemiConden\";\n"
"background-color: rgb(255, 255, 255);\n"
"border: 3px solid #e6b31e;\n"
"border-radius: 10px;\n"
"")
        self.BuscarRegistradosPacientesText_5.setObjectName("BuscarRegistradosPacientesText_5")
        self.horizontalLayout_15.addWidget(self.BuscarRegistradosPacientesText_5)
        self.BuscarBotonRegistrados_5 = QtWidgets.QPushButton(self.frame_62)
        self.BuscarBotonRegistrados_5.setMinimumSize(QtCore.QSize(130, 70))
        self.BuscarBotonRegistrados_5.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.BuscarBotonRegistrados_5.setStyleSheet("QPushButton{\n"
"    background-color: #343434;\n"
"    font: 87 14pt \"Arial Black\";\n"
"    color: whitesmoke;\n"
"    border-radius: 5px;\n"
...
"\n"
"")
        self.BuscarBotonRegistrados_5.setObjectName("BuscarBotonRegistrados_5")
        self.horizontalLayout_15.addWidget(self.BuscarBotonRegistrados_5)
        self.verticalLayout_36.addWidget(self.frame_62)
        self.frame_63 = QtWidgets.QFrame(self.HistorialCambios)
        ...
        self.TablaEmpleados_9 = QtWidgets.QTableWidget(self.frame_63)
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold SemiConden")
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        self.TablaEmpleados_9.setFont(font)
        self.TablaEmpleados_9.setStyleSheet("QHeaderView::section{\n"
"    padding: 5px;\n"
"    background-color: #77838d;\n"
"    border: .5px solid #034aa6;\n"
"    font: 87 13pt \"Arial Black\";\n"
...
"\n"
"")
        self.TablaEmpleados_9.setAutoScrollMargin(16)
        self.TablaEmpleados_9.setDragEnabled(False)
        self.TablaEmpleados_9.setWordWrap(True)
        self.TablaEmpleados_9.setObjectName("TablaEmpleados_9")
        self.TablaEmpleados_9.setColumnCount(4)
        self.TablaEmpleados_9.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.TablaEmpleados_9.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.TablaEmpleados_9.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.TablaEmpleados_9.setHorizontalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.TablaEmpleados_9.setHorizontalHeaderItem(3, item)
        self.TablaEmpleados_9.horizontalHeader().setCascadingSectionResizes(False)
        self.TablaEmpleados_9.horizontalHeader().setDefaultSectionSize(158)
        self.TablaEmpleados_9.horizontalHeader().setHighlightSections(False)
        self.TablaEmpleados_9.horizontalHeader().setSortIndicatorShown(False)
        self.TablaEmpleados_9.horizontalHeader().setStretchLastSection(True)
        self.TablaEmpleados_9.verticalHeader().setVisible(False)
        self.TablaEmpleados_9.verticalHeader().setSortIndicatorShown(False)
        self.verticalLayout_37.addWidget(self.TablaEmpleados_9)
        self.RefrescarBotonRegistrados_7 = QtWidgets.QPushButton(self.frame_63)
        self.RefrescarBotonRegistrados_7.setMinimumSize(QtCore.QSize(130, 70))
        self.RefrescarBotonRegistrados_7.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.RefrescarBotonRegistrados_7.setStyleSheet("QPushButton{\n"
"    background-color: #343434;\n"
"    font: 87 14pt \"Arial Black\";\n"
"    color: whitesmoke;\n"
"    border-radius: 5px;\n"
...
"\n"
"")
        self.RefrescarBotonRegistrados_7.setObjectName("RefrescarBotonRegistrados_7")
        self.verticalLayout_37.addWidget(self.RefrescarBotonRegistrados_7)
        self.verticalLayout_36.addWidget(self.frame_63)
        self.verticalLayout_36.setStretch(0, 3)
        self.verticalLayout_36.setStretch(1, 10000)
        self.stackedWidget.addWidget(self.HistorialCambios)
        ...
        #Botones historial cambios
        self.pushButton_18.clicked.connect(lambda: self.stackedWidget.setCurrentWidget(self.HistorialCambios))
        self.pushButton_17.clicked.connect(lambda: self.stackedWidget.setCurrentWidget(self.HistorialCambios))
        ...
        self.pushButton_10.clicked.connect(lambda: self.realizarVentaProducto(cursor))
            #Generar Ticket
        self.pushButton_28.clicked.connect(lambda: self.generarTicket(cursor, fecha, name, self.opc,id))
            #Cancelar venta
        ...
        self.RefrescarBotonRegistrados_7.clicked.connect(lambda: self.historialCambiosTabla())
        self.BuscarBotonRegistrados_5.clicked.connect(lambda: self.busquedaHistorial())
        """
    ...
    def registrarEmpleado(self, cursor):
        ...
        if len(nombre)==0:
            ...
            proceso="Se registro empleado con nombre {}".format(nombre)
            ...
            if opc == "Buscar por ID:":
                ...
                if len(row)==0:
                    ...
                    for rows in row:
                        ...
                        self.actualizar.append(str(rows[1]));
                        self.actualizar.append(str(rows[2]));
                        self.actualizar.append(str(rows[3]));
                        self.actualizar.append(str(rows[4]));
                        self.actualizar.append(str(rows[5]));
                        self.actualizar.append(str(rows[6]));
                        self.actualizar.append(str(rows[7]));
                        self.actualizar.append(str(rows[8]));
                        self.actualizar.append(str(rows[9]));
            else:
    ...
    def actualizarEmpleado(self, cursor):
        ...
        if len(nombre)==0:
            ...
            aux=[nombre,fechIngreso,naci,tel,rol,curp,NSS,RFC,passw]
            sinAct=list(set(self.actualizar)-set(aux))
            yaAct=list(set(aux)-set(self.actualizar))  
            yaAct.reverse()
            proceso="Se actualizo de {} a {}".format(sinAct,yaAct)
            self.cambios(proceso) 
    ...
    def eliminarEmpleados(self, cursor):
        ...
        if len(nombre)==0 or len(tel)==0 or len(fech)==0 or len(ult)==0:
            ...
            proceso="Se elimino empleado con ID {} y nombre {} ".format(id,nombre)
            self.cambios(proceso)
    ...
    def Agregar_Entrenador(self, cursor):
        ...
        if len(nombre)==0:
            ...
            proceso="Se registro entrenador con nombre {} ".format(nombre)
            self.cambios(proceso)
            ...
            if opc == "Buscar por ID:":
                ...
                if len(row)==0:
                    ...
                    for rows in row:
                        ...
                        self.actualizar.append(rows[1])
                        self.actualizar.append(rows[2])
                        self.actualizar.append(rows[3])
                        self.actualizar.append(rows[4])
                        self.actualizar.append(rows[5])
                        self.actualizar.append(rows[6])
                        self.actualizar.append(rows[7])
            else:
    ...
    def actualizarEntrenador(self, cursor):
        ...
        if len(nombre)==0:
            ...
            aux=[nombre,fechIngreso,naci,tel,curp,NSS,RFC]
            sinAct=list(set(self.actualizar)-set(aux))
            yaAct=list(set(aux)-set(self.actualizar))  
            yaAct.reverse()
            proceso="Se actualizo de {} a {}".format(sinAct,yaAct)
    ...
    def eliminar_Entrenador(self, cursor):
        ...
        if len(nombre)==0 or len(fechIngreso)==0 or len(naci)==0 or len(tel)==0 or len(curp)==0 or len(NSS)==0 or len(RFC)==0:
            ...
            proceso="Se elimino entrenador con id {} y nombre {}".format(id,nombre)
            self.cambios(proceso)
    ...
    def registrarCliente(self, cursor, date):
        ...
        if len(nombre)==0:
            ...
            proceso="Se registro cliente con nombre {}".format(nombre)
            self.cambios(proceso)
    ...
    def asignarEntrenador(self, cursor):
        ID_Cliente=self.NombreRegistrar_5.text()
        nombreEntrenador=self.NombreRegistrar_10.text()
        if len(ID_Cliente)==0:
            ...
            if len(ID_Entrenador)==0:
                ...
                proceso="Se le asigno el entrenador {} al id {}".format(nombreEntrenador,ID_Cliente)
                self.cambios(proceso)
            ...
            if opc == "Buscar por ID:":
                ...
                if len(row)==0:
                    ...
                    for rows in row:
                        ...
                        self.actualizar.append(str(rows[5]))
                        self.actualizar.append(str(rows[6]))
                        self.actualizar.append(str(rows[10]))
            else:
                SQL="""select * from cliente where nombre_cliente like '%{}%' """.format(data)
                cursor.execute(SQL)
                row=cursor.fetchall()
    ...
    def ActualizarCliente(self, cursor):
        ...
        if len(nombre)==0:
            ...
            aux=[nombre,telefono,correo,edad,peso,altura,password]
            sinAct=list(set(self.actualizar)-set(aux))
            yaAct=list(set(aux)-set(self.actualizar))  
            yaAct.reverse()
            proceso="Se actualizo de {} a {}".format(sinAct,yaAct)
    ...
    def EliminarCliente(self, cursor):
        nombre=self.Eliminar_NombrePaciente_2.text()
        data = self.ID_BuscarEliminarPaciente_3.text()
        if len(data)==0:
            self.msgError("Busqueda", "Debes realizar una busqueda valida primero antes de eliminar")
        else:
            ...
            if opc == "Buscar por Nombre:":
                ...
                if len(row)==0:
                    ...
                    proceso="Se elimino cliente con ID {} y nombre {} ".format(id,nombre)
                    self.cambios(proceso)
                    try:
                        cursor.execute(SQL)     
                        cursor.connection.commit()
                ...
                try:
                    cursor.execute(SQL)     
                    cursor.connection.commit()
                    proceso="Se elimino cliente con ID {} y nombre {} ".format(data,nombre)
                    self.cambios(proceso)
                except Exception as ex:
                    print(ex)
                self.Eliminar_NombrePaciente_2.clear()
    ...
    def registrarMembresia(self, cursor):
        ...
        if len(meses)==0:
            ...
            procesos="Se registro membresia con meses {} y precio {} ".format(meses,precio)
            self.cambios(procesos)
    ...
    def registrarProducto(self,cursor):
        ...
        proceso="Se registro producto con nombre {} y cantidad {} ".format(nombre,cantidad)
        self.cambios(proceso)
            ...
            if opc == "Buscar por Codigo:": 
                ...
                if len(row)==0:
                    ...
                    for rows in row:
                        ...
                        self.actualizar.append(rows[5])
                        self.actualizar.append(rows[6])
                        self.actualizar.append(rows[8])
                        self.actualizar.append(rows[9])
            else:
    ...
    def actualizarProducto(self,cursor):
        ...
        if len(nombre)==0:
            ...
            aux=[nombre,cantidad,distribui,lote,categoria,precio,descripcion,direccionfoto]
            sinAct=list(set(self.actualizar)-set(aux))
            yaAct=list(set(aux)-set(self.actualizar))  
            yaAct.reverse()
            proceso="Se actualizo de {} a {}".format(sinAct,yaAct)
    ...
    def eliminarProducto(self,cursor):
        ...
        if len(nombre)==0 or len(cantidad)==0 or len(lote)==0 or len(categoria)==0:
            ...
            proceso="Se elimino producto con ID: {} y nombre: {}".format(id,nombre)
            self.cambios(proceso)
    ...
    def cancelarVentaProducto(self):
        ...
        self.carrito.clear()
        self.CantidadTotal=0.0
        proceso="Se cancelo una venta de productos :("
        self.cambios(proceso)
    ...
    def generarTicket(self, cursor, date, name, opc,id):
        ...
        if (len(data)) == 0:
            ...
            for rows in self.carrito:
                ...
                if opc == 0 :
                    ...
                    proceso="El usuario {} realizo una venta de un total de {}".format(id,cantidad)
                    self.cambios(proceso)
                    ...
                    cursor.execute(SQL)     
                    cursor.connection.commit()
                    proceso="El usuario {} realizo una venta de membresia de total de {}".format(id,cantidad)
                    self.cambios(proceso)
    ...
    def cancelarMembresiaVenta(self):
        ...
        self.carrito.clear()
        self.CantidadTotal=0.0
        proceso="Se cancelo una venta de membresia :("
        self.cambios(proceso)
    ...
    def registrarVisita(self, cursor):
        ...
        id = self.plainTextEdit.toPlainText()
        if (len(id)) != 0:
                proceso="Se registro visita del ID:{}".format(id);
                self.cambios(proceso);
    ...
    def historialCambiosTabla(self):
        self.TablaEmpleados_9.clearContents()
        cambios=[]
        if os.path.exists('procesos.pickle'):
            archivo = open('procesos.pickle', 'rb')
            while True:
                try:
                    cambios.append(pickle.load(archivo))
                except EOFError:
                    break
            archivo.close()
        print(cambios)
        self.TablaEmpleados_9.setRowCount(len(cambios))
        for fila, cambios in enumerate(cambios):
            for columna, valor in enumerate(cambios.values()):
                item = QTableWidgetItem(valor)
                self.TablaEmpleados_9.setItem(fila, columna, item)
    ...
    def busquedaHistorial(self):
        ...
        if os.path.exists('procesos.pickle'):
            ...
            archivo.close()
        print(cambios)
        data=self.BuscarRegistradosPacientesText_5.text()
        if len(data)==0:
            self.msgError("Busqued no valida", "Debes Ingresar informacion valida para buscar")
        else:
            opc=self.BuscarRegistradosCombobox_8.currentText()
            if opc == "Buscar por ID:":
                self.TablaEmpleados_9.clearContents()
                fila_actual=0
                for cambio in cambios:
                    hecho_por = cambio['Hecho por:']
                    if hecho_por == str(data):
                        fecha = cambio['Fecha:']
                        hora = cambio['Hora:']
                        proceso = cambio['Proceso hecho:']
                        self.TablaEmpleados_9.setRowCount(fila_actual+1)
                        self.TablaEmpleados_9.setItem(fila_actual, 0, QTableWidgetItem(str(hecho_por)))
                        self.TablaEmpleados_9.setItem(fila_actual, 1, QTableWidgetItem(fecha))
                        self.TablaEmpleados_9.setItem(fila_actual, 2, QTableWidgetItem(hora))
                        self.TablaEmpleados_9.setItem(fila_actual, 3, QTableWidgetItem(proceso))
                        fila_actual += 1
    ...
    def retranslateUi(self, MenuAdministrativo):
        ...
        self.label_131.setText(_translate("MenuAdministrativo", "Teflon Academy"))
        ...
        self.label_159.setText(_translate("MenuAdministrativo", "Historial cambios"))
        ...
        self.radioButton_4.setText(_translate("MenuAdministrativo", "Membresía"))
        ...
        self.label_60.setText(_translate("MenuAdministrativo", "Categoria:"))
        ...
        self.label_155.setText(_translate("MenuAdministrativo", "Foto del producto:"))
        self.pushButton_13.setText(_translate("MenuAdministrativo", "Seleccionar foto del producto"))
        self.comboBox.setItemText(0, _translate("MenuAdministrativo", "Suplementos"))
        self.comboBox.setItemText(1, _translate("MenuAdministrativo", "Membresías"))
        self.comboBox.setItemText(2, _translate("MenuAdministrativo", "Consumibles"))
        self.comboBox.setItemText(3, _translate("MenuAdministrativo", "Accesorios"))
        ...
        self.pushButton_16.setText(_translate("MenuAdministrativo", "Seleccionar nueva foto del producto"))
        ...
        self.label_158.setText(_translate("MenuAdministrativo", "Foto del producto:"))
        self.comboBox_2.setItemText(0, _translate("MenuAdministrativo", "Suplementos"))
        self.comboBox_2.setItemText(1, _translate("MenuAdministrativo", "Membresías"))
        self.comboBox_2.setItemText(2, _translate("MenuAdministrativo", "Consumibles"))
        self.comboBox_2.setItemText(3, _translate("MenuAdministrativo", "Accesorios"))
        ...
        self.label_199.setText(_translate("MenuAdministrativo", "Tipo de membresía:"))
        self.label_201.setText(_translate("MenuAdministrativo", "Código producto:"))
        self.pushButton_37.setText(_translate("MenuAdministrativo", "Buscar"))
        self.label_200.setText(_translate("MenuAdministrativo", "Nombre producto:"))
        self.label_198.setText(_translate("MenuAdministrativo", "Precio:"))
        self.label_202.setText(_translate("MenuAdministrativo", "ID del cliente:"))
        self.label_203.setText(_translate("MenuAdministrativo", "Total:"))
        self.label_204.setText(_translate("MenuAdministrativo", "Descuento:"))
        self.pushButton_38.setText(_translate("MenuAdministrativo", "Agregar"))
        ...
        self.pushButton_31.setText(_translate("MenuAdministrativo", "Cancelar venta"))
        self.pushButton_23.setText(_translate("MenuAdministrativo", "Realizar Venta"))
...
"¡Gracias por su compra!"))
        ...
        self.label_148.setText(_translate("MenuAdministrativo", "Contraseña:"))
        ...
        self.label_154.setText(_translate("MenuAdministrativo", "Contraseña:"))
        ...
        self.EliminarPacienteBoton.setText(_translate("MenuAdministrativo", "Eliminar empleado."))
        ...
        self.label_152.setText(_translate("MenuAdministrativo", "<html><head/><body><p><span style=\" font-weight:696; color:#ffffff;\">Ingresa el id del entrenador para ver sus clientes asignados</span></p></body></html>"))
        ...
        self.BuscarRegistradosCombobox_8.setItemText(0, _translate("MenuAdministrativo", "Buscar por fecha:"))
        self.BuscarRegistradosCombobox_8.setItemText(1, _translate("MenuAdministrativo", "Buscar por ID:"))
        self.BuscarBotonRegistrados_5.setText(_translate("MenuAdministrativo", "Buscar"))
        self.TablaEmpleados_9.setSortingEnabled(False)
        item = self.TablaEmpleados_9.horizontalHeaderItem(0)
        item.setText(_translate("MenuAdministrativo", "Hecho por:"))
        item = self.TablaEmpleados_9.horizontalHeaderItem(1)
        item.setText(_translate("MenuAdministrativo", "Fecha cambio:"))
        item = self.TablaEmpleados_9.horizontalHeaderItem(2)
        item.setText(_translate("MenuAdministrativo", "Hora cambio:"))
        item = self.TablaEmpleados_9.horizontalHeaderItem(3)
        item.setText(_translate("MenuAdministrativo", "Cambio hecho:"))
        self.RefrescarBotonRegistrados_7.setText(_translate("MenuAdministrativo", "Refrescar"))
